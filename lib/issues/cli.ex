defmodule Issues.CLI do
  ...
  @doc """
    ...
    Otherwhise it is a github username, project name and (optionally)
    the number of entries to format.

    Return a tuple of `{user, project, coung}`, or `:help` if help was passed.
  """
  ...
  def decode_response({:error, error}) do
    IO.puts List.keyfind(error, "message", 0)
